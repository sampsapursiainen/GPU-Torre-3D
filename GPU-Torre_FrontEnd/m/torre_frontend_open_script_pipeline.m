...
set(torre.h_frontend_script_pipeline,'Name',[gputorre_name ' Frontend: Script pipeline']);
...
set(findobj(torre.h_frontend_script_pipeline.Children,'-property','FontSize'),'FontSize',torre_fontsize);

 set(torre.h_frontend_script_pipeline,'Position',[ 975   275   458   575]);